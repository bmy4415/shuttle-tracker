...
### 12. 인앱 피드백 시스템 (베타테스트용) - 완료 ✅
- [x] **FeedbackModel 구현**
  - [x] 피드백 상태 (pending/reviewing/resolved)
  - [x] 사용자 컨텍스트 자동 첨부 (userId, userName, role, groupId, screenName)
  - [x] 개발자 답변 필드 (Firebase Console에서 수동 입력)
- [x] **FeedbackService 구현**
  - [x] Firestore 'feedback' 컬렉션 연동
  - [x] 피드백 제출 기능
  - [x] 내 피드백 목록 조회 (실시간 스트림)
- [x] **FeedbackDialog 위젯**
  - [x] AlertDialog 기반 피드백 입력 UI
  - [x] 텍스트 검증 (최소 5자 이상)
  - [x] 자동 컨텍스트 첨부 정보 표시
- [x] **FeedbackListScreen 화면**
  - [x] 내 피드백 목록 표시
  - [x] 상태별 뱃지 (접수됨/확인중/해결됨)
  - [x] 개발자 답변 표시
  - [x] FAB로 새 피드백 작성
- [x] **라우터 및 UI 통합**
  - [x] /feedback 라우트 추가
  - [x] 학부모 홈 화면에 피드백 아이콘 추가
  - [x] 기사 홈 화면에 피드백 아이콘 추가
